...
router.get('/', async(req, res) => {
  ...
  res.render('layout', {layout: 'signup',title: 'Sign up',college:collegedata.result});
});
...
router.post('/', async (req, res) => {
  ...
  // 添加用户
  let insertUser=await User.insertuserHandler({user_id:id,user_name:name,college_id:college,password:r,salt:salt});
   console.log(1);
